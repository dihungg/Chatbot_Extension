...
export default class MessageManager {
  ...
  /**
   * INIT: setup initial system + context + task info
   * NOTE: example/tool call is intentionally neutral (no active click/next_goal) to avoid seeding previous goals.
   */
  ...
  /**
   * addNewTask: mark explicitly as NEW task (not follow-up) to avoid reusing cached goals
   */
