  ...
  return (
    <div
      ...
      <div className="min-w-0 flex-1">
        {!isSameActor && (
          <div className={`mb-1 text-base font-semibold ${isDarkMode ? 'text-gray-200' : 'text-gray-900'}`}>
            {actor.name}
          </div>
        )}

        <div className="space-y-0.5">
          <div className={`whitespace-pre-wrap break-words text-base ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            {isProgress ? (
          ...
          {!isProgress && (
            <div className={`text-right text-base ${isDarkMode ? 'text-gray-500' : 'text-gray-300'}`}>
